...
{{ component('inset-text', {
  html: 'You must only share and discuss OFFICIAL data. <a href="https://service-manual-mod.herokuapp.com/security/security-classifications">Find out about security classifications</a>.'
}) }}
