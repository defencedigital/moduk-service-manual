...
Read more about [collecting data from participants]({{ meta.baseURL }}user-research/collecting-data-from-participants).
...
Check the [how to protect participants’ data and identities]({{ meta.baseURL }}user-research/share-user-research-findings-correctly).
