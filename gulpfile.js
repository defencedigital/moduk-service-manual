...
const watcher = () => {
  watch('./app/styles/**/*.scss', {ignoreInitial: true}, styles);
  watch('./app/assets/**/**/*.*', {ignoreInitial: true}, images);
};


// The default (if someone just runs `gulp`) is to run each task in parrallel after cleaning our public folder
exports.default = series(clean, parallel(styles, images));
...
exports.prod = series(clean, parallel(styles, images, nunjucks), html);
